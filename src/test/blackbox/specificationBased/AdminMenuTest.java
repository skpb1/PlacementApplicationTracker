...
public class AdminMenuTest {
	...
	void setup() {
		...
		adminMenu = new AdminMenu(visitRepo, applicationRepo, placementRepo, assessmentRepo, interviewRepo, adminRepo,
				feedbackRepo);
	}
	...
	@Test
	void testManagePlacementOpportunities() {
		Scanner scanner = new Scanner("1\n5\n");
		adminMenu.displayAdminMenu(1, scanner);
	}

	@Test
	void testManagePlacementApplications() {
		Scanner scanner = new Scanner("2\n5\n");
		adminMenu.displayAdminMenu(1, scanner);
	}

	@Test
	void testManageVisits() {
		Scanner scanner = new Scanner("3\n5\n");
		adminMenu.displayAdminMenu(1, scanner);
	}

	@Test
	void testManageAssessments() {
		Scanner scanner = new Scanner("4\n5\n");
		adminMenu.displayAdminMenu(1, scanner);
	}

	@Test
	void testManageInterviews() {
		Scanner scanner = new Scanner("5\n5\n");
		adminMenu.displayAdminMenu(1, scanner);
	}

	@Test
	void testManagePersonalDetails() {
		Scanner scanner = new Scanner("6\n5\n");
		adminMenu.displayAdminMenu(1, scanner);
	}
