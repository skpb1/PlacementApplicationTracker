...
public class AdminApplicationProcessMenuTest {
    ...
    @Test
    void testApproveApplicationOption() {
    ...
    @Test
    void testRejectApplicationOption() {
        Scanner scanner = new Scanner("1\nr\n6");
        applicationRepo.createApplication(1, 1, "abc", "abc");
        menu.displayMenu(1, scanner);
    }
    ...
    @Test
    void testProvideFeedbackOption() {
    ...
    @Test
    void testManageAssessmentOption() {
    ...
    @Test
    void testManageInterviewOption() {
