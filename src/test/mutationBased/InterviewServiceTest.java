...
public class InterviewServiceTest {
    ...
    @Test
    public void testAddInterviewFalse() {    	
    	boolean isAdded = interviewService.addInterview(null);
    	assertFalse(isAdded);
    }
    ...
    @Test
    public void testUpdateInterviewFalse() {
    	boolean isUpdated = interviewService.updateInterview(1, null);
    ...
    @Test
    public void testDeleteInterviewFalse() {
    	boolean isDeleted= interviewService.deleteInterview(1);
