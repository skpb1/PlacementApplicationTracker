...
class AuthenticationServiceTest {
    ...
    @Test
    void testStudentLoginFalse() {
        int studentId = 1;
        String password = "studentPassword";
        assertFalse(authenticationService.studentLogin(studentId, password));
    }
    ...
    @Test
    void testAdminLoginFalse() {
        int adminId = 1;
        String password = "adminPassword";

        assertFalse(authenticationService.adminLogin(adminId, password));
    }
    ...
    @Test
    void testDoesAdminIdDoesnotExist() {
        int adminId = 1;

        assertFalse(authenticationService.doesAdminIdExist(adminId));
    }
    ...
    @Test
    void testDoesStudentIdDoesnotExist() {
        int studentId = 1;

        assertFalse(authenticationService.doesStudentIdExist(studentId));
    }
