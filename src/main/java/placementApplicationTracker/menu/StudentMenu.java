			...
			try {
				...
				case 1:
					...
					if (student != null) {
						...
						try {
							boolean isUpdated = StudentService.updateStudentDetails(studentId, updatedFullName,
				...
				case 4:
					...
					if (student != null) {
						...
						try {
							boolean isPasswordUpdated = StudentService.updateStudentPassword(studentId, currentPassword,
									newPassword);
