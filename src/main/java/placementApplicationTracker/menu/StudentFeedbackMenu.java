...
public class StudentFeedbackMenu {
	private static final Logger LOGGER = Logger.getLogger(StudentFeedbackMenu.class.getName());

	public static void displayFeedbackMenu(int applicationId, Scanner scanner) {
