...
public class AdminDetailsMenu {
    ...
    private static final Logger LOGGER = Logger.getLogger(AdminDetailsMenu.class.getName());

    public static void displayEditDetailsMenu(Admin admin, Scanner scanner) {
                    ...
                    case 1:
                        ...
                        try {
                            boolean isUpdated = AdminService.updateAdminDetails(
                                    admin.getAdminId(), updatedFullName, updatedEmail, updatedDesignation);
    ...
    public static void editPasswordMenu(Admin admin, Scanner scanner) {
        ...
        try {
            boolean isPasswordUpdated = AdminService.updateAdminPassword(admin.getAdminId(), enteredCurrentPassword, newPassword);
